---
id: catching-unbroken-waves
title: Catching Unbroken Waves
description: Move from broken waves to catching clean, unbroken faces by reading energy, matching angle, and trusting gravity.
icon: 🟢
order: 22
type: path
# Ordered list controls sidebar and inline link numbering
nodes:
  - ocean-knowledge
  - read-waves
  - positioning
...
1. Physics-first thinking — momentum and gravity are your engines.
2. Angle matching — align your board with the slope of the face as it forms.
3. Courage through control — paddling downhill, not hesitating as the wave steepens.
...
Learn more: [Ocean Knowledge](:ocean-knowledge), [Reading Waves](:read-waves)
...
Focus skills: [Positioning](:positioning)
...
Helpful skills: [Paddling Efficiency](:paddling-efficiency), [Cobra Pose](:cobra-pose)
...
Speed control: [Trimming and Speed](:trimming-and-speed)
...
Line and glide: [Angling Down the Line](:angling-down-the-line), [Trimming and Speed](:trimming-and-speed)
...
Exit cleanly: [Kick‑outs](:kick-outs)

---

### Summary: The Green‑Wave Equation

1. Read the wave as a living curve, not static stages.
2. Position just ahead of the energy, where lift begins.
3. Match your board’s angle to the wave’s slope.
4. Paddle downhill, not away from it.
5. Trust gravity — it’s your engine, not your enemy.
