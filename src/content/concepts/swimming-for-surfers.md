...
category: preface
related:
  [total-immersion, stroke-rate-vs-stroke-length, swimming-metrics-for-surfers]
---
...
- See: [Total Immersion](:total-immersion)
...
- See also: [Stroke Rate vs Stroke Length](:stroke-rate-vs-stroke-length) and [Swimming Metrics for Surfers](:swimming-metrics-for-surfers)
