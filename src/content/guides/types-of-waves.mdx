...
import spillingWave from "../../assets/spilling-wave.png";
import plungingWave from "../../assets/plunging-wave.png";
import surgingWave from "../../assets/surging-wave.png";
...
<Image
  src={spillingWave}
  alt="Spilling wave diagram showing the energy release pattern"
  width={800}
/>
...
<Image
  src={plungingWave}
  alt="Plunging wave diagram showing the powerful curl and tube formation"
  width={800}
/>
...
<Image
  src={surgingWave}
  alt="Surging wave diagram showing the wave pushing up the shore"
  width={800}
/>
